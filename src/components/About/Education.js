    ...
    const learningPlaces = [
        {
            school: 'FoxmindEd',
            descr:
                'Learning Frontend Development at one of the best programming schools in Ukraine',
            years: '2022-2023',
        },
        {
            school: 'Gamma Intelligence OÜ',
            descr:
                'Intensive course for beginner Frontend Developers based on ReactJS',
            years: '2022-2023',
        },
        {
            school: 'Self-Study',
